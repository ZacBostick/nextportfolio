...
const ExperienceItem: React.FC<ExperienceItemProps> = ({ experience, index, last }) => {
    ...
    return (
        <motion.li 
            ...
            className={`mb-10 ml-4 ${last ? '' : 'mb-10'}`}
        >
            ...
            <p className="mb-4 text-base font-normal text-gray-400">Location: {experience.location}</p>
...
const ExperienceSection = () => {
    return (
        <div className="bg-0A0A0B min-h-screen text-white">
            <Navbar />
            <motion.div className="container mx-auto mt-20 space-y-16 md:space-y-24 px-4 md:px-16 lg:px-32">
